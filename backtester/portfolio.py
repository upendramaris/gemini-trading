...
class Portfolio:
    ...
    def __init__(self, bars, events, start_date, initial_capital=100000.0):
        """
        Initialises the portfolio with bars and an event queue. Also includes a starting datetime index and initial capital.
        Parameters:
    ...
    def update_timeindex(self, event):
        ...
        This reflects the PREVIOUS bar, i.e. all current market data at this stage is known
        at the time of receiving the MarketEvent.
    ...
    def update_positions_from_fill(self, fill):
        ...
        """
        # Check if the fill is a buy or a sell
        fill_dir = 0
    ...
    def update_holdings_from_fill(self, fill):
        ...
        fill_cost = self.bars.get_latest_bar_value(fill.symbol, "Adj Close")  # Close price
    ...
    def create_sharpe_ratio(self, returns, periods=252):
        """
        Create the Sharpe ratio for the strategy, based on a benchmark of zero (i.e. no risk-free rate taken into account).
        Parameters:
